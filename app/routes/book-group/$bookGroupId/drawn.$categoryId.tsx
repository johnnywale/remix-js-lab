...
export const action: ActionFunction = async ({request, params}) => {
    ...
    try {
        ...
        return {message: `Reviews added successfully`, variant: 'success'};
    } catch (err) {
        return {
            ...
            {book ? (
                <div>
                    <div className="mb-4">
                        ...
                        <p>
                            Start date: <span>{new Date(book.dateStart).toLocaleDateString()}</span>
                        </p>
                        <p>
                            Planned completion date: <span>{new Date(book.dateEnd).toLocaleDateString()}</span>
                        </p>
                    </div>
                    <div>
                        <h6>Opinie:</h6>
                    ...
                    <Form method="POST">
                        ...
                        <FloatingLabel className="mb-3" controlId="rate" label="Rating">
                            <Form.Control
                                type="number"
                                min={0}
                                max={10}
                ...
                <Alert variant="info">No selected book</Alert>
            )}
        </>
    );
}
